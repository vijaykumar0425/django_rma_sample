...
from django_audit import settings
from .models import CRUDEvent, LoginEvent, RequestEvent
from .admin_helpers import prettify_json, EasyAuditModelAdmin
from requestlogging.settings import  CRUD_EVENT_LIST_FILTER, LOGIN_EVENT_LIST_FILTER, REQUEST_EVENT_LIST_FILTER
from requestlogging.settings import ADMIN_SHOW_AUTH_EVENTS, ADMIN_SHOW_MODEL_EVENTS, ADMIN_SHOW_REQUEST_EVENTS
